    ...
    \innerblock{Project status and plan}{
        \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \item manual validation (larger annotation team including both L1 and L2 Swedish speakers)
            \end{enumerate}
            \item \textbf{L2 (originals) annotation}:
            \begin{enumerate}
                \item automatic pre-annotation with a custom parser
    ...
    \innerblock{Open questions}{
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item parallel editing/viewing (as with STUnD)
            \end{itemize}
            \item \textbf{L2-specific guidelines}:
            \begin{itemize}
                \item to what extent to should take into account the syntactic annotation of a the correction when annotating an original sentence?
                ...
                \item should the existing L1-specific guidelines be applied when annotating constructions the learner borrowed from their first language?
            \end{itemize}
        \end{itemize}
    }
}
...
\block{Acknowledgement}{
    Participation to the training school is funded by UniDive. 
    This annotation project is supported by the Swedish National Research Infrastructure Nationella Språkbanken, funded jointly by the Swedish Research Council (2018–2024, contact 2017-00626) and the ten participating partner institutions.
