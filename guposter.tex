...
\author{\textbf{Arianna Masciolini}, Maria Irena Szawerna and Elena Volodina}
...
\block{UD Treebanks in SLA Research}{
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item possibility to carry out \textbf{grammatical error analysis} without explicit error tagging e.g. if learner sentences are paired with corrections (\textbf{\textit{parallel L1-L2 treebank}})
